...
class M_Pegawai_Admin extends CI_Model{
  ...
  function get_all_data(){
    ...
    $db->where('status_kepegawaian', 'Pegawai');
  ...
  function get_all_data_dosen(){
    $db = $this->load->database('default', TRUE);
    $db->where('status_kepegawaian', 'Dosen');
    $data = $db->get('vw_profil_biodata');
    return $data->result();
  }
  ...
  function save_golongan(){
    $data = array(
        ...
        'sk_file'     => $this->input->post('sk_file')
      );
    $result=$this->db->insert('tbl_golongan_pegawai',$data);
    return $result;
  }
  ...
  function save_jabatan_fungsional(){
    $data = array(
        ...
        'jabFa'  => $this->input->post('jabFa'), 
        'sejak_tanggal' => $this->input->post('sejak_tanggal'),
        'surat_keputusan'     => $this->input->post('surat_keputusan')
      );
    $result=$this->db->insert('tbl_jabatan_fungsional_akademik_pegawai',$data);
    return $result;
  }
  ...
  function save_fakultas_pegawai(){
    $data = array(
        'nip_pegawai'   => $this->input->post('nip_pegawai_fakultas'), 
        'kd_fakultas'  => $this->input->post('kd_fakultas'), 
        'sejak_tanggal' => $this->input->post('sejak_tanggal_fakultas'),
        'surat_keputusan'     => $this->input->post('surat_keputusan_fakultas')
      );
    $result=$this->db->insert('tbl_fakultas_pegawai',$data);
    return $result;
  }
