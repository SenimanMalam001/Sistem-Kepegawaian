          ...
          <div class="col-md-10">
            <input class="form-control" type="text" name="id_edit" id="id_edit" disabled>
				...
				<div class="form-group row">
						<label class="col-md-2 col-form-label">Nama Rubrik</label>
						<div class="col-md-10">
              <input type="text" id="nama_rubrik_edit" class="form-control" readonly>
						</div>
				</div>
				<div class="form-group row">
						<label class="col-md-2 col-form-label">Tanggal Awal</label>
...
<div class="modal fade" id="Modal_Edit_Anggota" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
        ...
        <h4 class="modal-title">Edit Anggota</h4>
			...
			<div class="modal-body">
				<input type="hidden" name="keanggotaan_sk_edit" id="keanggotaan_sk_edit">
        <input type="hidden" id="keanggotaan_nip_edit" name="keanggotaan_nip_edit">
...
<!-- Upload SK -->
<?php echo form_open_multipart('admin/surat-keputusan/upload');?>
