            ...
            <div class="row">
                ...
                <div class="row" style="padding-top: 10px">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a data-toggle="tab" href="#golongan">Golongan/Jab.Fungsional</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div id="penelitian" class="tab-pane fade" >
                        <div class="row col-lg-12" style="padding-top: 10px">
                            <div class="row">
                              <div class="col-md-12" style="padding-left: 50px;">
                                <h2 class="page-header" style="text-align: center;"><i class="fa fa-graduation-cap" aria-hidden="true"> Penelitian</i></h2>
                                <div class="float-right"><a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" id="tambah" data-target="#Modal_Add"><span class="fa fa-plus"></span> Tambah</a>
                                </div>
                                <table class="table table-hover">
                                  <thead>
                    ...
                    <div id="pengabdian" class="tab-pane fade" >
                        <div class="row col-lg-12" style="padding-top: 10px">
                            <div class="row">
                              <div class="col-md-12" style="padding-left: 50px;">
                                <h2 class="page-header" style="text-align: center;"><i class="fa fa-graduation-cap" aria-hidden="true"> Pengabdian</i></h2>
                                <div class="float-right"><a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" id="tambah" data-target="#Modal_Add"><span class="fa fa-plus"></span> Tambah</a>
                                </div>
                                <table class="table table-hover">
                                  <thead>
