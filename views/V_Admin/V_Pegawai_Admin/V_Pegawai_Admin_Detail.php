                ...
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                        <div class="row col-lg-12" style="padding-top: 20px">
                            <!-- row 1  -->
                            <form role="form" name="form" action="<?php echo base_url() ?>C_Pegawai_Admin/simpan_edit" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <!-- left column -->
                                <div class="col-md-4">
                                    <!-- box 1 -->
                                        ...
                                        <div class="panel-footer">
                                            <small>DOSEN PROGRAM STUDI MAIN DOTA                               
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <button type="hide" type="button" type="submit" id="btn_simpan_profil" class="btn btn-primary btn-xs pull-right" hidden onclick="<?php echo base_url().'C_Pegawai_Admin/simpan_edit'?>"> Simpan</button>
                                                </div>
